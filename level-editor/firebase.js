...
import { getFirestore, collection as fbCol, collectionGroup as fbColGroup, doc as fbDoc, setDoc as fbSetDoc, getDocs as fbGetDocs, deleteDoc as fbDelDoc, query as fbQuery, orderBy as fbOrderBy } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-firestore.js";
...
let signInWithPopup, signOut, collection, collectionGroup, doc, setDoc, getDocs, deleteDoc, query, orderBy;
...
export { auth, provider, db, signInWithPopup, signOut, collection, collectionGroup, doc, setDoc, getDocs, deleteDoc, query, orderBy };
